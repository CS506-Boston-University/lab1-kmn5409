class X:
    ...
    def evaluate(self, x_value):
        # X evaluates to the given x_value
        return Int(x_value)
...
class Int:
    ...
    def simplify(self):
        # Integer constants cannot be simplified further
        return self
...
class Sub:
    ...
    def __repr__(self):
        ...
        # Add parentheses around right operand if it's Add or Sub
...
class Div:
    ...
    def __repr__(self):
        ...
        # Add parentheses around numerator if it's Add/Sub
        if isinstance(self.p1, (Add, Sub)):
            left = f"( {left} )"
        # Add parentheses around denominator if it's Add/Sub
        if isinstance(self.p2, (Add, Sub)):
            right = f"( {right} )"
    ...
    def evaluate(self, x_value):
        v1 = self.p1.evaluate(x_value)
        v2 = self.p2.evaluate(x_value)
        return Int(v1.i // v2.i)  # integer division
